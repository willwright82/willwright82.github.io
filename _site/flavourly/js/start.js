...
startupKit.uiKitHeader._inFixedMode = function(headerClass) {
    ...
    if(fixedNavbarHeader.hasClass('fake-header')) {
        ...
        var fakeHeader = $('<div class="fake-wrapper-header" style="width: 100%; height: 0px;" />');
    }
    ...
    if ($(headerClass + ' .navbar').hasClass('navbar-fixed-top')) {
        ...
        var antiflicker = $('<div class="' + headerClass.slice(1) + '-startup-antiflicker header-antiflicker" style="opacity: 0; position: fixed; z-index: 2; left: 0; top: 0; width: 100%; height: 70px;" />');
