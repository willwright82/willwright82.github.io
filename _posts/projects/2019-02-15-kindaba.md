...
- Kindaba’s market research (2016–2017) found that over half of parents preferred to keep children’s photos and videos off open social media, and diaspora families craved private ways to stay connected across borders.
- Interviews with parents, grandparents and multicultural families emphasized strong preferences for privacy, trusted networks, and reduced cognitive clutter on feeds.
...
- **Invite-only Circles:** Family networks could not be found by strangers; all connections were initiated and confirmed by users.
- **No ads, no data selling:** Commitment to profit without exploiting user data built immediate trust.
...
#### UX Innovations
- **Clean, focused interface:** Made frictionless sharing with family the centerpiece—no public feed, trending, or clutter.
- **Time Travel:** Allowed users to quickly review milestones, old photos, and memories as groups or individuals within the circle.
...
- Secured early-stage funding (£30k Seed Haus, £55k pre-seed, investment from Skyscanner co-founder Gareth Williams).
- Built and beta-launched Kindaba to first cohort of parents, diaspora users and privacy advocates; 100k user target planned for scale-up.
- Recognized for innovation in Scottish start-up scene and featured among Edinburgh’s top social/family technology companies.
